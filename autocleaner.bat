rem This script was written by Borz Bahadori Dev - Published 
rem email: bahadoriborz@gmail.com
cls
...
echo.
echo Mission Successfully Done!, You can exit by pressing any key.
echo.
